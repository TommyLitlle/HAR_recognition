...
if __name__ == "__main__":
    ...
    for i in range(24):
        ...
        cost +=tf.reduce_sum(-(1/(24-i+1))*Y*tf.log(y+ 1e-8))
    ...
    prediction = tf.add((1/2)*pred_Y, (1/3)*pred_second)
    ...
    for i in range(config.training_epochs+600):
        ...
        print(classification_report(label_, y_put, digits=6))
